...
g.ad(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.Db(a)},EBa=function(a,b){var c=g.Ed("SCRIPT");
...
g.bd(c,g.ce("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},FBa=function(){var a=DBa(),b=window.document.getElementById(a),c=b&&g.dF(b,"loaded");
...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;HBa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",j7,c)}},KBa=function(){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
...
a.pd&&(c=null);var d=(0,g.z)(a.lW,a);c||(c=new g.wm("//www.google.com/images/cleardot.gif"),S6(c));UBa(c.toString(),1E4,d)}else t7(2);kCa(a,b)},kCa=function(a,b){a.g=0;
