...
h[f].length;if(l=xg[c])a:{var m=h,t=c;if(l.videoId)var G="VIDEO";else if(l.playlistId)G="PLAYLIST";else break a;m.credentialTransferTokenTargetId=l;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=[{token:t,scope:G}]}delete xg[c];l=h;l.requestTimeMs=b;if(G=R("EVENT_ID",void 0))m=(R("BATCH_CLIENT_COUNTER",void 0)||0)+1,m>rg&&(m=1),Q("BATCH_CLIENT_COUNTER",m),l.serializedClientEventId={serializedEventId:G,clientCounter:m};Dg(e,d,h,{retry:ug.has(d)})}c=
g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete X[a]}}lb(X)||Cg()}}
